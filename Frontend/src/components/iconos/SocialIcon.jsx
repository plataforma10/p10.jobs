...
import socialIconStyle from "../../assets/styles/components/socialIconStyle.jsx";
...
class SocialIcon extends Component {
    ...
    render() {
        ...
        return (
            <a href={href} target={tarjetBlanck ? "_blank" : ""}>
...
SocialIcon.propTypes = {
    ...
    tarjetBlanck: PropTypes.bool
  };

export default withStyles(socialIconStyle)(SocialIcon);
